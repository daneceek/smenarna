...
class Application(tk.Tk):
    ...
    def __init__(self):
        ...
        self.varAuto = tk.BooleanVar(value=self.load_checkbox_state())
    ...
    def calculate_conversion(self, *args):
        ...
        if self.entryAmount.value == "":
            ...
            try:
                ...
                self.entryAmount.value = self.entryAmount.value[:-1]
    ...
    def save_checkbox_state(self):
        with open(self.settings_file, "wb") as f:
            pickle.dump({"checkbox_state": self.varAuto.get()}, f)
    ...
    def load_checkbox_state(self):
        ...
        try:
            with open(self.settings_file, "rb") as f:
                data = pickle.load(f)
            return data.get("checkbox_state", False)
